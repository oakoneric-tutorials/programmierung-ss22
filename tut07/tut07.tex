...
\begin{frame} \frametitle{Lehrveranstaltungsevaluation}
	\begin{minipage}{\dimexpr0.6\linewidth-\fboxrule-\fboxsep}
		\centering
		\includegraphics[width=\linewidth]{evaluation-twitter.jpg} \\
	\end{minipage}
	\begin{minipage}{\dimexpr0.4\linewidth-\fboxrule-\fboxsep}
		\centering \small
		\includegraphics[width=.95\linewidth]{evaluation-gr.png} \\
		\vspace{-\baselineskip}
		\url{https://tud.link/uqo3} 	
	\end{minipage}
	
	\begin{tikzpicture}[remember picture, overlay]
		\node [
			font=\scriptsize\color{cdgray!80},  % Einstellungen für die Schrift
		...
		{Originallink: \url{https://befragung.zqa.tu-dresden.de/uz/de/sl/7086HheP0Rky}};
	\end{tikzpicture}	
\end{frame}
